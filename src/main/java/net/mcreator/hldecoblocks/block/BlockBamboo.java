...
public class BlockBamboo extends ElementsHldecoratedMod.ModElement {
	@GameRegistry.ObjectHolder("hldecorated:bamboo")
	public static final Block block = null;
	public BlockBamboo(ElementsHldecoratedMod instance) {
		super(instance, 194);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("hldecorated:bamboo", "inventory"));
	}

...
public class BlockAnds60 extends ElementsHldecoratedMod.ModElement {
	@GameRegistry.ObjectHolder("hldecorated:ands_60")
	public static final Block block = null;
	@GameRegistry.ObjectHolder("hldecorated:ands_60_double")
	public static final Block block_slab_double = null;
	public BlockAnds60(ElementsHldecoratedMod instance) {
		super(instance, 184);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ands_60"));
		elements.blocks.add(() -> new BlockCustom.Double().setRegistryName("ands_60_double"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("hldecorated:ands_60", "inventory"));
	}
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("ands_60");
